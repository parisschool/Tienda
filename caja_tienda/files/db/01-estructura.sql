...
CREATE TABLE `pago_cliente` (
  ...
  `pago_cliente_monto_plan` decimal(10,2) DEFAULT NULL,
  `pago_cliente_monto_iva` decimal(10,2) DEFAULT NULL,
  `pago_cliente_monto_total` decimal(10,2) DEFAULT NULL,
  `usuario_id` int(11) NOT NULL,
  ...
  `pago_forma_efectivo_monto` decimal(10,2) DEFAULT NULL,
  `pago_forma_tarjeta_monto` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `venta_detalle` (
  ...
  KEY `idx_pago_cliente` (`pago_cliente_id`),
  KEY `idx_producto` (`producto_id`),
  CONSTRAINT `fk_venta_detalle_pago` FOREIGN KEY (`pago_cliente_id`) REFERENCES `pago_cliente` (`pago_cliente_id`) ON DELETE CASCADE
