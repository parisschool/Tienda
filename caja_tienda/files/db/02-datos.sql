...
VALUES
('1', 'Configuración', NULL, 'fa fa-cogs', NULL),
('2', 'Menú', '1', NULL, 'menu'),
('2', 'Mantenimiento sistema', '1', NULL, 'mantenimiento_sistema'),
('1', 'Mantenimiento', NULL, 'fa fa-database', NULL),
('2', 'Usuarios', '4', NULL, 'usuarios'),
('2', 'Productos', '4', NULL, 'productos'),
('1', 'Transacciones', NULL, 'fa fa-money', NULL),
('2', 'Pagos', '7', NULL, 'pagos'),
('1', 'Ventas', NULL, 'fa fa-shopping-cart', NULL),
('2', 'Ventas', '9', NULL, 'ventas');
-- Grupo
...
-- Permisos:
-- Super Admin: Configuración (Menú, Mant. sistema), Usuarios, Productos, Pagos, Ventas
-- Administrador: Productos, Pagos, Ventas (sin Usuarios ni Configuración)
INSERT INTO `grupo_permisos` (`grupo_id`, `menu_id`, `grupo_acciones_id`) VALUES
('1', '2', '1'), ('1', '3', '1'),
